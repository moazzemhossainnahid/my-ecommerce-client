...
const ProductDetails = ({ product }) => {
    const { _id, category, price, img, name, ratings, seller, shipping } = product;
    return (
        <div className="card w-5/6 group bg-base-100 shadow-xl hover:shadow-2xl hover:shadow-gray-500 rounded-xl mx-auto">
            <figure><img className='w-4/5 mx-auto rounded-full p-3 m-5 group-hover:scale-105 group-hover:rotate-45 hover:border border-red-700 duration-200' src={img} alt="Shoes" /></figure>
