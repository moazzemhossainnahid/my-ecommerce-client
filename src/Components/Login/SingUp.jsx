...
const SignUp = () => {
  ...
  return (
    <div >
      <div className="flex items-center min-h-screen text-left p-4 lg:justify-center">
        <div
          ...
          <div className="p-5 bg-white md:flex-1">
            ...
            <form onSubmit={handleSubmit(onSubmit)} action="#" className="flex flex-col space-y-5">
              ...
              <div>
                ...
                <p className='text-gray-500 text-bold'>Already have an account? <Link to="/signin" className=' text-light text-[#A25BF7]'>Please Login</Link></p>
              </div>
